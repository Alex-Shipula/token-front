                ...
                <div className="row topConDrops">
                    <div className="col-md d-flex">
                        ...
                        <div className="dropdown show filterShow">
                            <select onChange={(e) => { e.preventDefault(); this.props.changePurchasePrice(e.target.value)}} class="rounded-control sorting-select filter-generation ">
                                <option value="">Price</option>
                                <option value="-1">Expensive</option>
                                <option value="1">Cheapest</option>
                            </select>

                            <select onChange={(e) => { e.preventDefault(); this.props.changePurityPer(e.target.value)}} class="rounded-control sorting-select filter-generation ">
